...
const Care = () => (
  <section className={styles.section}>
    ...
    <div className={styles.text}>
      ...
      <h5>
        This means that there is no payment for the development. We do all the work and ensure your
        website attracts more customers. We analyze the traffic flow, how users interact and with
        this data, determine how much to charge you on that month. As the only way we earn money is
    ...
    <div className={styles.subText}>
      <h3>
        If you want ownership of the base code or simply want traditional pricing options, we offer
